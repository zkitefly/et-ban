...
- **代理容器**: 监听 11221 端口，检查客户端 IP，如果是中国大陆 IP 则拒绝，否则转发到 10110 端口
- **easytier 容器**: 运行 easytier/easytier:latest 镜像，监听 10110 端口
...
5. 否则，建立到目标服务器（**10110** 端口，easytier 服务）的连接
6. 双向转发数据
